...
from code.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, EVENT_TIMEOUT, \
    TIMEOUT_STEP, TIMEOUT_LEVEL, WIN_WIDTH, TIMEOUT_LEVEL3
...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int], only_enemy3=False):
        self.timeout = TIMEOUT_LEVEL
        self.enemies = []
        self.window = window
        self.name = name
        self.only_enemy3 = only_enemy3 
